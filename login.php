...
@keyframes xfade{
	...
	* {margin:0 ;boder: 0; padding:0}
	...
	<body style="margin: 0px;height:100%;width:100%">
		...
		?>
		<div id="a">
			<text id="b" style="line-height:2em;padding-left:140px">All You Need In One Place</text>
			<a id="aLink" href=""><img id="adminImg" onclick="adminPassword()" style="margin-left:700px;margin-top:10px" src="../style/admin.ico"/></a>
		</div>
